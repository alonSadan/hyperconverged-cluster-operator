...
import (
	...
	hcov1alpha1 "hyperconverged-cluster-operator/pkg/apis/hco/v1alpha1"
...
func getKubevirtDefaultConfigurationsAsMap() map[string]string {
json.Marshal(defaultKubevirtConfigurations())	
}
