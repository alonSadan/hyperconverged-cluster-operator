...
type FeatureGates struct {
	DataVolumes      bool `json:"DataVolumes,omitempty"`
	SRIOV            bool `json:"SRIOV,omitempty"`
	LiveMigration    bool `json:"LiveMigration,omitempty"`
	CPUManager       bool `json:"CPUManager,omitempty"`
	CPUNodeDiscovery bool `json:"CPUNodeDiscovery,omitempty"`
